...
export const MusicPlayer = () => {
    ...
    useEffect(() => {
        ...
        audio.addEventListener("loadedmetadata", hadleLoadedMetadata);
        audio.addEventListener("canplay", hadleLoadedMetadata);
        audio.addEventListener("timeupdate", handleTimeUpdate);
        audio.addEventListener("ended", handleEnded);

        return () => {
            audio.removeEventListener("loadedmetadata", hadleLoadedMetadata);
            audio.removeEventListener("canplay", hadleLoadedMetadata);
